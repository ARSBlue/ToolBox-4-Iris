...
- [Server-side Event Handling](#server-side-event-handling)
  ...
  - [Asynchronous Event Handling](#asynchronous-event-handling)
    - [Treatment by User Process](#treament-by-user-process)
  ...
  - [System Events](#system-events)
    ...
    - [Handle System Event asynchronously with Event Queue](#handel-system-event-asynchronously-with-event-queue)
